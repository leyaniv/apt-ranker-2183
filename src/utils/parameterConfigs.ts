...
export const PARAMETER_CONFIGS: ParameterConfig[] = [
  ...
  },
  {
    ...
    shortLabel: { en: "Air Dir", he: "כיוון" },
    values: ["N", "E", "S", "W"],
  ...
  },
  {
    ...
    shortLabel: { en: "# Dirs", he: "מס׳ כיוונים" },
    values: ["1", "2", "3"],
  ...
  },
  {
    ...
    shortLabel: { en: "Balcony", he: "מרפסת" },
    values: [],
    valueLabels: {},
  },
  {
    ...
    shortLabel: { en: "Balc Dir", he: "כ׳ מרפסת" },
    values: ["N", "E", "S", "W"],
    valueLabels: DIRECTION_LABELS,
  },
  {
